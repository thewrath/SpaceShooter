...
ifeq ($(config),debug64)
  ...
  TARGETDIR  = ../../../bin
  TARGET     = $(TARGETDIR)/SpaceShooterd.exe
...
ifeq ($(config),profile64)
  ...
  TARGETDIR  = ../../../bin
  TARGET     = $(TARGETDIR)/SpaceShooterp.exe
...
ifeq ($(config),release64)
  ...
  TARGETDIR  = ../../../bin
  TARGET     = $(TARGETDIR)/SpaceShooter.exe
  DEFINES   +=
  INCLUDES  += -I$(ORX)/include -I../../../include/Scroll -I../../../include
  ALL_CPPFLAGS  += $(CPPFLAGS) -MMD -MP $(DEFINES) $(INCLUDES)
  ALL_CFLAGS    += $(CFLAGS) $(ALL_CPPFLAGS) -ffast-math -g -msse2 -O2 -m64
...
$(OBJDIR)/SpaceShooter.o: ../../../src/SpaceShooter.cpp
	@echo $(notdir $<)
	$(SILENT) $(CXX) $(ALL_CXXFLAGS) $(FORCE_INCLUDE) -o "$@" -MF "$(@:%.o=%.d)" -c "$<"
